...
<div class="shopcart" :class="{ highligh: totalCount>0 }">
    ...
    <div class="content-left">
      <div 
				class="logo-wrapper" :class="{ highligh: totalCount>0 }"
      ...
      <div class="desc-wrapper">
        ...
        <p 
					class="tip" :class="{ highligh: totalCount>0 }"
	...
	<div class="shopcart-mask" style="display:none"></div>
</div>
</template>
